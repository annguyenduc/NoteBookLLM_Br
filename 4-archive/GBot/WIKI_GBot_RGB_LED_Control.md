...
- [x] **[Rule 14]** Đã mở file nguồn trong 3-resources/raw/ và xác nhận fact tồn tại (Câu 13: Vị trí đèn LED số 3; Câu 15: Nếu không có lệnh chờ thì đèn chỉ hiện màu cuối cùng).
