...
## MỤC TIÊU
Tạo ~10 Wiki Pages mẫu từ file `3-resources/raw/LMS_KB_IOT.md`
vào `3-resources/wiki/` theo đúng template `WIKI_TEMPLATE.md`.

## ĐIỀU KIỆN TIÊN QUYẾT
- [ ] `3-resources/raw/LMS_KB_IOT.md` tồn tại
- [ ] `3-resources/wiki/WIKI_TEMPLATE.md` tồn tại
- [ ] `3-resources/log.md` tồn tại
...
CHECKPOINT:
  ...
  prerequisites:
    - file: "3-resources/raw/LMS_KB_IOT.md"
      exists: "?"
    - file: "3-resources/wiki/WIKI_TEMPLATE.md"  
      exists: "?"
  status: "READY | BLOCKED"
```

Sau khi confirm CHECKPOINT:
1. Đọc file `3-resources/raw/LMS_KB_IOT.md`
...
CHECKPOINT:
  ...
  step: "2 / 4"
  output_file: "3-resources/wiki/ATOMS_[TAG].md × 5 files"
...
Với MỖI tag:
1. Đọc template tại `3-resources/wiki/WIKI_TEMPLATE.md`
2. Tạo file `3-resources/wiki/ATOMS_[tên_tag_snake_case].md`
...
5. Phần "Nguồn": ghi chính xác `3-resources/raw/LMS_KB_IOT.md — tag [TÊN TAG]`
...
Mở từng file trong `3-resources/wiki/`, kiểm tra checklist:
...
[ ] Nguồn trace được về 3-resources/raw/LMS_KB_IOT.md?
