...
6.  **📖 Nguồn**: Trích dẫn chính xác file trong `brain/raw/`.

## 3. Quy tắc vàng (Rule Checklist)
- [ ] **Rule 7 (Flatness)**: Lưu trực tiếp vào `brain/wiki/`, không tạo thư mục con. Tên file: `WIKI_[NHÓM]_[TÊN].md`.
- [ ] **Rule 14 (Source Integrity)**: Phải mở file raw trong `brain/raw/` trước khi trích dẫn.
