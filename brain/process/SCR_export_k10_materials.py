...
MATERIALS = {
    "Math_10": [
        ROOT / "brain/atoms/ATOMS_Prompt_Engineering_K10_Toan.md",
    ...
    "English_10": [
        ROOT / "brain/atoms/ATOMS_Prompt_Engineering_K10_Anh.md",
    ...
    "Literature_10": [
        ROOT / "brain/atoms/ATOMS_Prompt_Engineering_K10_Van.md",
