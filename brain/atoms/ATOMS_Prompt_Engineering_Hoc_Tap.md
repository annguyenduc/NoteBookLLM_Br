...
## 🔗 Liên kết tư duy
- [[ATOMS_AI_vs_LLM]] — AI là gì, LLM là gì
- [[ATOMS_Trach_Nhiem_Nguoi_Hoc_AI]] — Trách nhiệm khi dùng AI học tập
- [[ATOMS_Gemini_Guided_Learning]] — Tính năng Guided Learning của Gemini
- Thực hành: [[ATOMS_Mau_Prompt_Hoc_Tap_K10]] — Các mẫu prompt thực chiến cho HS khối 10.
