...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId6.png)
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId7.png)
- A/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId8.png)
- B/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId9.png)
- C/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId10.png)
- D/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId11.png)
Câu 3 (Thông hiểu)
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId12.png)
...
- A/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId13.png)
- B/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId14.png)
- C/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId15.png)
- D/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId16.png)
Câu 5 (Thông hiểu)
Đoạn lệnh nào sau đây làm cho màn hình LCD hiện lên dòng chữ như sau?
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId17.png)
- A/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId18.png)
- B/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId19.png)
- C/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId20.png)
- D/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId21.png)
Câu 6 (Thông hiểu)
Đoạn lệnh nào sau đây làm cho màn hình LCD hiện lên dòng chữ như sau?
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId22.gif)
- A/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId23.png)
- B/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId24.png)
- C/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId25.png)
- D/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId26.png)
Câu 7 (Thông hiểu)
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId27.png)
...
- A/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId28.png)
- B/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId29.png)
- C/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId30.png)
- D/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId31.png)
Câu 9 (Nhận biết)
Nhận định nào sau đây là đúng khi nói về cảm biến siêu âm HC-SR04?
(Nhiều đáp án)
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId32.png)
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId33.png)
- A/ VCC - GND - Out
- B/ VCC - Out - GND
- C/ GND - VCC - Out
- D/ Out - GND - VCC
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId34.png)
...
- A/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId35.png)
- B/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId36.png)
- C/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId37.png)
- D/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId38.png)
Câu 12 (Nhận biết)
Nhận định nào sau đây là đúng khi nói về cách kết nối mạch L298, động cơ với Arduino và nguồn điện?
(Nhiều đáp án)
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId39.png)
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId40.png)
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId41.png)
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId42.png)
Hỏi để điều chỉnh cho xe chạy thẳng khi khởi động, ta có thể sử dụng đoạn lệnh nào sau đây?
- A/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId43.png)
- B/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId44.png)
- C/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId45.png)
- D/
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId46.png)
Câu 14 (Thông hiểu)
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId47.png)
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId48.png)
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId42.png)
...
Đế 4 pin |  | 2
Breadboard |  | 1
Động cơ vàng, bánh xe |  | 2
Màn hình I2C LCD 16x2 |  | 1
Cảm biến nhiệt độ, độ ẩm DHT11 |  | 1
Mắt thu hồng ngoại IR1838 |  | 1
LED RGB |  | 3
(3 màu khác nhau)
Các loại dây jumper |  | 1
Bìa carton 40x40 |  | 1
Bình xịt nước 
(phun sương) |  | 1
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId61.png)
4. Đáp án:
...
Điểm thực hành = Điểm Tinkering x 0.3 + Điểm Mạch điện x 0.4 + Điểm Code x 0.3
Các thông số điểm được tính theo thang điểm 10. | Điểm thực hành = Điểm Tinkering x 0.3 + Điểm Mạch điện x 0.4 + Điểm Code x 0.3
Các thông số điểm được tính theo thang điểm 10. | Điểm thực hành = Điểm Tinkering x 0.3 + Điểm Mạch điện x 0.4 + Điểm Code x 0.3
Các thông số điểm được tính theo thang điểm 10. | Điểm thực hành = Điểm Tinkering x 0.3 + Điểm Mạch điện x 0.4 + Điểm Code x 0.3
Các thông số điểm được tính theo thang điểm 10. | Điểm thực hành = Điểm Tinkering x 0.3 + Điểm Mạch điện x 0.4 + Điểm Code x 0.3
Các thông số điểm được tính theo thang điểm 10. | Điểm thực hành = Điểm Tinkering x 0.3 + Điểm Mạch điện x 0.4 + Điểm Code x 0.3
Các thông số điểm được tính theo thang điểm 10.
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId63.png)
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId65.png)
3/ Khi khởi động, có sử dụng câu lệnh “IR ReceiveNo.1: Set digital pin” để kết nối mắt thu hồng ngoại với Arduino. (0.5đ)
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId66.png)
...
![Visual](media/cu-chua-sua-extension-kdi-de-trac-nghiem-1-arduino-m2/rId67.png)
