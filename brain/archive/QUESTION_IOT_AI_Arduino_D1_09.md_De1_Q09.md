---
file_id: "QUESTION_IOT_AI_Arduino_D1_09_De1_Q09"
title: "Câu 9: Kết nối trên Breadboard"
category: "Atomic Question"
prefix: "QUESTION"
tags: ["Arduino", "Hardware", "Breadboard", "Nhận biết"]
...
![Image](../assets/IMG_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId13.png)

## 📝 Đáp án lựa chọn
- **A/ Các lỗ ở khu vực B hoặc C được kết nối theo hàng dọc, mỗi cột 5 lỗ được kết nối với nhau. (Đáp án)**
...
## 💡 Giải thích
Trên Breadboard tiêu chuẩn:
- Hai dải ngoài cùng (thường có vạch xanh/đỏ) nối thông theo hàng ngang (dùng cho nguồn).
- Các dải ở giữa chia thành từng cột 5 lỗ nối thông theo hàng dọc.
