"""
generate_atoms_v2.py — Tạo atomic notes từ các file LMS_RAW_*.md
Chạy từ root repo: python scripts/generate_atoms_v2.py
...
def run():
    print("=" * 60)
    print(f"  generate_atoms_v2.py — {'DRY RUN' if DRY_RUN else '🚨 GHI FILE THẬT'}")
    print("=" * 60)
