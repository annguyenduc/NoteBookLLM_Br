...
- `[[THINK_Audience_Framing]]`: Đặt câu chuyện vào đúng khung nhận thức của khán giả.
- `[[THINK_Exploration_vs_Confirmation]]`: Tầm nhìn (Vision) là kim chỉ nam trong quá trình thăm dò dữ liệu.
