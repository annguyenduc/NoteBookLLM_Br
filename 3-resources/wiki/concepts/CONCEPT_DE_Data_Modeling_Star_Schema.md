...
- **Ẩn dụ sư phạm (Pedagogical)**: Giống như một động từ trong câu. Bảng Fact là "Động từ" (Hành động: Bán hàng). Các bảng Dimension là các "Trạng từ" trả lời cho câu hỏi: Ai mua? Mua cái gì? Mua ở đâu? Mua khi nào? Nếu không có trạng từ, động từ trở nên vô nghĩa.
