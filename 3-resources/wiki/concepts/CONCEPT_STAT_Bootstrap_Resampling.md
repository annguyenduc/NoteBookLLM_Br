...
- **Ẩn dụ sư phạm (Pedagogical)**: Giống như việc bạn muốn biết một nồi canh có ngon không nhưng chỉ được nếm đúng 1 thìa duy nhất. Bạn múc 10 thìa nhỏ khác nhau từ chính thìa đó (sau khi đổ lại nồi - Sampling with replacement) để có cái nhìn tổng quan về độ đậm nhạt của cả nồi canh thay vì chỉ tin vào một lần nếm duy nhất.
