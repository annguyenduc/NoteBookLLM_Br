...
## 2. Tại sao DA cần EV?
Hầu hết các mô hình Machine Learning chỉ đưa ra xác suất (ví dụ: Khách hàng này có 70% khả năng rời đi). Khung EV giúp chuyển đổi xác suất đó thành **Số tiền** hoặc **Quyết định kinh doanh** (ví dụ: Có nên tặng voucher 100k cho khách hàng này không?).
...
> **Nguồn**: [[SOURCE_Data_Science_For_Business]] — Page 194-195.
...
## 4. Trích dẫn nguồn
- **Nguồn**: [[SOURCE_Data_Science_For_Business]] — Chapter 7 & 11.
