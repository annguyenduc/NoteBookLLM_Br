...
- **Ẩn dụ sư phạm (Pedagogical)**: DAX giống như các công thức "phép thuật" trên một chiếc máy tính bỏ túi vạn năng. Thay vì cộng trừ tay từng con số, bạn thiết lập một quy tắc thông minh để máy tự động tính toán lại kết quả chính xác mỗi khi bạn thay đổi các điều kiện quan sát (lọc dữ liệu).
