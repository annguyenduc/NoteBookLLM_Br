...
title: Hệ sinh thái [[ENTITY_Python|Python]] dành cho Khoa học Dữ liệu
category: CONCEPT
domain: Python
status: verified
---
...
2.  **[[ENTITY_PANDAS|pandas]]:** Cung cấp các cấu trúc dữ liệu bậc cao (`DataFrame`) giúp thao tác với dữ liệu bảng (tabular data) dễ dàng như [[ENTITY_EXCEL|Excel]] hoặc [[ENTITY_SQL|SQL]].
