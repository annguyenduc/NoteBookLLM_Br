...
- **Ẩn dụ sư phạm (Pedagogical)**: Giống như việc bạn dạy một đứa trẻ làm việc nhà. Thay vì nói "Hãy dọn phòng đi" (Zero-shot), bạn làm mẫu cho nó: "Đây là cách gấp chăn, đây là cách xếp đồ chơi vào giỏ" (Few-shot). Đứa trẻ sẽ hiểu nhanh và làm đúng hơn nhiều.
