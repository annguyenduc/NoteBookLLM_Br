...
- **Ngôn ngữ chính:** Các biểu thức tính toán bản ngữ (LOD, Table Calcs) và khả năng tích hợp sâu với R/Python.
...
| **Hệ sinh thái** | Microsoft (Azure, SQL Server, O365). | Salesforce, đa nền tảng, cộng đồng mã nguồn mở. |
