...
entity: concept
type: technical
tags: [sql, cte, recursion, performance]
...
Nguồn: [[SOURCE_Phụ lục B (Common Table Expressions), TOOL_SQL_Cookbook]] (Xác nhận Rule 14 từ: [[\Phụ lục B (Common Table Expressions), TOOL_SQL_Cookbook]])
