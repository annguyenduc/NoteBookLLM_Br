...
- [[SYNTHESIS_THINK_Analytical_Thinking]] | **Master: Tư duy Phân tích & Giải quyết vấn đề (Analytical Thinking)**
  > Tất cả các phương pháp luận đều thống nhất về một quy trình lặp (Iterative Process) cơ bản:
- [[SYNTHESIS_PYTHON_Data_Mastery]] | **Python Mastery: Data Processing & Analysis**
...
- [[SYNTHESIS_DA_Case_Study_Library]] | **📚 Thư viện Case Study: Phân tích dữ liệu thực chiến**
  > Thư viện này là nơi tổng hợp các kịch bản phân tích dữ liệu thực tế (Case Studies), kết nối các kỹ thuật đơn lẻ từ SQL, ...
...
- [[CONCEPT_THINK_Data_Evidence_Types]] | **4 Loại Bằng chứng trong Lập luận Dữ liệu** **[DRAFT]**
...
- [[CONCEPT_Pandas_Wrangling_Advanced]] | **CONCEPT: Pandas Advanced Wrangling (Hợp nhất và Tái cấu trúc)**
  > Tương tự như phép JOIN trong SQL, kết nối các dòng dựa trên các khóa (keys).
- [[CONCEPT_Pandas_Aggregation]] | **CONCEPT: Pandas Aggregation (Gom nhóm và Tổng hợp)**
  > Dữ liệu có thể được gom nhóm theo nhiều cách:
- [[CONCEPT_Pandas_Data_Cleaning]] | **CONCEPT: Pandas Data Cleaning (Làm sạch dữ liệu)**
  > Pandas sử dụng `NaN` (Not a Number) làm giá trị sentinel để biểu diễn dữ liệu thiếu cho cả kiểu số và không phải số.
- [[CONCEPT_Pandas_Data_Transformation]] | **CONCEPT: Pandas Data Transformation (Biến đổi dữ liệu)**
  > Sử dụng `map` để thực hiện biến đổi trên từng phần tử dựa trên một hàm hoặc một từ điển ánh xạ.
- [[CONCEPT_SQL_Aggregations]] | **CONCEPT: SQL Aggregations (Gom nhóm & Thống kê)** **[VERIFIED]**
  > **Aggregations** là quá trình gom nhóm nhiều bản ghi (rows) lại với nhau để thực hiện các phép toán thống kê (như Đếm, T...
- [[CONCEPT_PY_pandas_Data_Structures]] | **Các cấu trúc dữ liệu cốt lõi của pandas** **[VERIFIED]**
...
- [[CONCEPT_THINK_Patterns_of_Reasoning]] | **Các Mô hình Lập luận (Patterns of Reasoning)**
  > id: THINK_Patterns_of_Reasoning
- [[CONCEPT_SQL_Sublanguages]] | **Các ngôn ngữ con trong SQL (SQL Sublanguages)** **[VERIFIED]**
  > SQL không chỉ là một ngôn ngữ đơn nhất mà bao gồm 4 nhóm ngôn ngữ con thực hiện các nhiệm vụ khác nhau trong quản trị và...
- [[CONCEPT_SQL_Set_Operations]] | **Các phép toán tập hợp trong SQL (Set Operations)** **[VERIFIED]**
  > Toán tử tập hợp cho phép bạn kết hợp kết quả của hai hoặc nhiều truy vấn thành một tập kết quả duy nhất.
- [[CONCEPT_SQL_CRUD_Operations]] | **Các thao tác CRUD trong SQL** **[VERIFIED]**
...
- [[CONCEPT_PY_GroupBy_Mechanics]] | **Cơ chế GroupBy: Split-Apply-Combine** **[VERIFIED]**
  > Cơ chế GroupBy trong pandas tuân theo mô hình **Split-Apply-Combine** (Chia - Áp dụng - Kết hợp), được giới thiệu bởi Ha...
- [[CONCEPT_THINK_Data_Story_Structure]] | **Cấu trúc Kể chuyện Dữ liệu (Data Story Structure / CoNVO)**
...
- [[CONCEPT_THINK_Entropy_Information_Gain]] | **Entropy và Information Gain (Độ lợi thông tin)** **[DRAFT]**
...
- [[CONCEPT_PY_Scientific_Ecosystem]] | **Hệ sinh thái Python dành cho Khoa học Dữ liệu** **[VERIFIED]**
  > Sức mạnh của Python trong phân tích dữ liệu không nằm ở bản thân ngôn ngữ mà ở hệ sinh thái các thư viện mã nguồn mở chu...
- [[CONCEPT_DSML_Supervised_vs_Unsupervised]] | **Học có giám sát và Học không giám sát (Supervised vs Unsupervised)** **[VERIFIED]**
...
- [[CONCEPT_THINK_CoNVO_Framework]] | **Khung CoNVO (Context, Need, Vision, Outcome)** **[DRAFT]**
...
- [[CONCEPT_SQL_Select_And_Filter]] | **Khái niệm: SQL Select & Filter (Truy xuất và Lọc dữ liệu)**
  > - [[SOURCE_TOOL_SQL_Getting_Started]]
- [[CONCEPT_THINK_Exploration_vs_Confirmation]] | **Khám phá và Xác nhận (Exploration vs Confirmation)**
...
- [[CONCEPT_DE_Data_Architecture_Basics]] | **Kiến trúc dữ liệu cơ bản (Warehouse vs Lake vs Lakehouse)** **[VERIFIED]**
  > Việc hiểu cách dữ liệu được lưu trữ ở quy mô lớn là chìa khóa để Data Analyst biết mình đang lấy dữ liệu từ đâu và chất ...
...
- [[CONCEPT_THINK_Data_Argumentation]] | **Lập luận bằng Dữ liệu (Data Argumentation)** **[DRAFT]**
...
- [[CONCEPT_DE_Data_Modeling_Star_Schema]] | **Mô hình hóa dữ liệu Star Schema (Star Schema Data Modeling)** **[VERIFIED]**
  > Star Schema là mô hình thiết kế cơ sở dữ liệu phổ biến nhất cho Business Intelligence, tập trung vào hiệu suất truy vấn ...
...
- [[CONCEPT_EXCEL_Monte_Carlo_Simulation]] | **Mô phỏng Monte Carlo trong Excel** **[VERIFIED]**
...
- [[CONCEPT_EXCEL_Sensitivity_Analysis]] | **Phân tích độ nhạy (Sensitivity Analysis) trong Excel** **[VERIFIED]**
...
- [[CONCEPT_DSML_Overfitting_Prevention]] | **Phòng tránh quá khớp (Overfitting Prevention)** **[VERIFIED]**
  > Overfitting là hiện tượng mô hình học quá kỹ dữ liệu huấn luyện (bao gồm cả nhiễu) dẫn đến khả năng dự báo kém trên dữ l...
- [[CONCEPT_THINK_Ensemble_Methods]] | **Phương pháp Tổ hợp (Ensemble Methods)**
  > Data[Dữ liệu gốc] --> M1[Mô hình 1]
- [[CONCEPT_SQL_Data_Preparation_Workflow]] | **Quy trình chuẩn bị dữ liệu phân tích với SQL** **[VERIFIED]**
...
- [[CONCEPT_VIZ_PowerBI_vs_Tableau]] | **So sánh Power BI và Tableau (Power BI vs Tableau)**
  > - **Triết lý:** "Tự phục vụ" (Self-service) cho mọi người. Dễ dàng bắt đầu nếu bạn đã quen với Excel.
...
- [[CONCEPT_SQL_Execution_Order]] | **Thứ tự thực thi câu lệnh SQL (Order of Execution)** **[VERIFIED]**
...
- [[CONCEPT_DSML_Model_Evaluation_Metrics]] | **Đánh giá mô hình (Model Evaluation Metrics)** **[VERIFIED]**
...
- [[SOURCE_coursera-AI-essential-Stay up to date with AI]] | **ACAD AI Essentials: Stay up to date with AI**
...
- [[SOURCE_THINK_Data_Science_for_Business]] | **ACAD Data Science for Business: What You Need to Know about Data Mining and Data-Analytic Thinking**
...
- [[SOURCE_THINK_Problem_Solving_101]] | **ACAD Problem Solving 101: A Simple Book for Smart People**
...
- [[SOURCE_THINK_Thinking_with_Data]] | **ACAD Thinking with Data**
- [[SOURCE_VIZ_10_Visualization_Tips]] | **TOOL 10 Visualization Tips for Better Data Storytelling**
- [[SOURCE_VIZ_Analyzing_Data_Power_BI]] | **TOOL Analyzing Data with Power BI and Power Pivot for Excel**
- [[SOURCE_TOOL_SQL_Getting_Started]] | **TOOL Getting Started with SQL: A Hands-On Approach for Beginners**
- [[SOURCE_VIZ_Introducing_Power_BI]] | **TOOL Introducing Power BI**
- [[SOURCE_VI_Introducing_Power_BI]] | **TOOL Introducing Power BI**
- [[SOURCE_VIZ_Mastering_Tableau_2021]] | **TOOL Mastering Tableau 2021**
- [[SOURCE_TOOL_Excel_Data_Analysis]] | **TOOL Microsoft Excel - Data Analysis and Business Modeling**
- [[SOURCE_DS_Python_Data_Science_Handbook]] | **TOOL Python Data Science Handbook**
- [[SOURCE_PY_Python_Data_Science_Handbook]] | **TOOL Python Data Science Handbook: Essential Tools for Working with Data**
...
- [[SOURCE_TOOL_SQL_Cookbook]] | **TOOL SQL Cookbook: Query Solutions and Techniques for All SQL Users**
- [[SOURCE_TOOL_SQL_for_Data_Analysis]] | **TOOL SQL for Data Analysis: Advanced Techniques for Transforming Data into Insights**
- [[SOURCE_TOOL_SQL_Pocket_Guide]] | **TOOL SQL Pocket Guide (4th Edition)**
