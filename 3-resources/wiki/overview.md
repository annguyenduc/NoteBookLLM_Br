...
Hệ thống hiện tại bao gồm **~100 trang tri thức nguyên tử**, được phân loại thành 8 nhóm cốt lõi:

| Nhóm tri thức | Số lượng trang | Trạng thái phủ tri thức | Trọng tâm |
| :--- | :--- | :--- | :--- |
| **🧠 Thinking** | 34 | 🟢 Hoàn tất 80/20 | Tư duy phản biện, Problem Solving, CoNVO Framework. |
| **🔢 Stats** | 10 | 🟡 Đang đào sâu | Thống kê mô tả, kiểm định giả thuyết, xác suất. |
| **💾 SQL** | 18 | 🟢 Hoàn tất | Truy vấn, tối ưu hóa, Window Functions. |
| **🐍 Python** | 7 | 🟡 Đang mở rộng | Pandas, NumPy, Scikit-Learn. |
| **📊 Visualization** | 12 | 🟢 Hoàn tất | Tufte principles, Storytelling, Tableau/PowerBI. |
| **⚙️ Data Engineering** | 6 | 🟡 Cơ bản | ETL/ELT, Data Modeling, Data Quality. |
| **🤖 DSML** | 6 | 🟡 Cơ bản | Thuật toán học máy, Evaluation Metrics. |
| **📚 Sources** | 33 | 🔵 Đã chuẩn hóa | Danh mục nguồn sách và khóa học. |
...
---
*Cập nhật lần cuối bởi @pm vào 2026-04-29. Hệ thống đã được làm sạch khỏi 1.600 file nhiễu.*
