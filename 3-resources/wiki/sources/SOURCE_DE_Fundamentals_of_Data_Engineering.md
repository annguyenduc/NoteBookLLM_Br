...
- **Kết nối Wiki:** Cung cấp tư duy hệ thống cho nhóm [[index]]. Kết nối mật thiết với [[CONCEPT_DE_Data_Architecture_Basics]] và [[CONCEPT_DE_ETL_ELT_Workflows]].
...
- [[CONCEPT_DE_Data_Modeling_Star_Schema]] | **Mô hình hóa dữ liệu** - Cách thiết kế kho dữ liệu hiệu quả.
