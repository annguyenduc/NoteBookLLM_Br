...
- **Kết nối Wiki:** Cung cấp lý thuyết nền tảng cho việc thiết kế Database của nhóm [[DE]]. Kết nối trực tiếp với [[CONCEPT_DE_Data_Modeling_Star_Schema]].
...
Cuốn sách định nghĩa lại cách thế giới xây dựng kho dữ liệu. Ralph Kimball giới thiệu phương pháp tiếp cận hướng người dùng, nơi dữ liệu được tổ chức thành các "Fact" (sự kiện) và "Dimension" (bối cảnh), giúp việc truy vấn bằng SQL trở nên trực quan và nhanh chóng hơn bao giờ hết.
