...
title: "TOOL SQL Pocket Guide (4th Edition)"
author: "Alice Zhao"
category: TOOL
domain: "Database / SQL"
status: "verified"
...
- **Kết nối Wiki:** Là tài liệu tham chiếu kỹ thuật cho nhóm [[SQL]]. Cung cấp các ví dụ thực tế cho [[CONCEPT_SQL_Advanced_Reporting]] và [[CONCEPT_SQL_Data_Preparation_Workflow]].
...
- [[CONCEPT_SQL_Advanced_Reporting.md]] | **Báo cáo nâng cao** - Sử dụng CTEs và Subqueries để xây dựng báo cáo phức tạp.
