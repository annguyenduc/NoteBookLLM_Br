---
file_id: "QUESTION_IOT_Arduino_D1_21"
title: "Câu hỏi: Câu 21 (Nhận biết)"
...
# [QUESTION] Câu 21 (Nhận biết)

## ❓ Câu hỏi
Phát biểu nào sau đây là đúng khi nói về khối lệnh “Broadcast” và “When I receive message”?

## 📝 Đáp án lựa chọn
- **A/ Việc truyền và nhận tin nhắn khi lập trình Arduino chỉ có thể sử dụng khi dùng chế độ LIV (Đáp án)**
- E. (Đáp án)
...
## 📖 Nguồn
`📖 Nguồn: [LMS_MASTER_Tự_động_hóa_và_IOT_AI_Arduino_Đề_trắc_nghiệm_1_-_AI_Arduino.md] — Câu 21`
