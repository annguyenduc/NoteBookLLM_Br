---
file_id: "QUESTION_ROBOT_Rover_D1_03"
...
## ❓ Câu hỏi
![Image](../assets/IMG_MASTER_Robotics_Rover_Đề_trắc_nghiệm_1_-_Rover_rId7.png)

Robot sẽ thực hiện những hành động gì khi chạy chương trình trên?

## 📝 Đáp án lựa chọn
- **A/ (Đáp án) Robot đi tới trong 1 giây sau đó đi lùi mãi mãi; Khi đi tới, đèn LED sáng đèn màu xanh lá, khi đi lùi, đèn LED sáng màu đỏ (Đáp án)**
...
## 📖 Nguồn
`📖 Nguồn: [LMS_MASTER_Robotics_Rover_Đề_trắc_nghiệm_1_-_Rover.md] — Câu 3`
