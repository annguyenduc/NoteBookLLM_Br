---
file_id: "QUESTION_IOT_Arduino_D1_01"
...
## 📝 Đáp án lựa chọn
- **A/ Kết nối bằng dây cáp kết nối. Cổng dùng để kết nối với máy tính là cổng USB - A type. Cổng dùng để kết nối với Arduino là cổng USB - B type. (Đáp án) (Đáp án)**
...
## 📖 Nguồn
`📖 Nguồn: [LMS_MASTER_Tự_động_hóa_và_IOT_AI_Arduino_Đề_trắc_nghiệm_1_-_AI_Arduino.md] — Câu 1`
