---
file_id: "QUESTION_IOT_Arduino_D1_14"
...
![Image](../assets/IMG_MASTER_Tự_động_hóa_và_IOT_AI_Arduino_Đề_trắc_nghiệm_1_-_AI_Arduino_rId28.png)

Đây là đoạn chương trình của học sinh đã thực hiện. Hỏi khi nhấn lá cờ xanh, những đèn LED nào sẽ phát sáng?

![Image](../assets/IMG_MASTER_Tự_động_hóa_và_IOT_AI_Arduino_Đề_trắc_nghiệm_1_-_AI_Arduino_rId29.png)

![Image](../assets/IMG_MASTER_Tự_động_hóa_và_IOT_AI_Arduino_Đề_trắc_nghiệm_1_-_AI_Arduino_rId30.png)

## 📝 Đáp án lựa chọn
- **A/ Chỉ có đèn xanh dương sáng. (Đáp án) (Đáp án)**
...
## 📖 Nguồn
`📖 Nguồn: [LMS_MASTER_Tự_động_hóa_và_IOT_AI_Arduino_Đề_trắc_nghiệm_1_-_AI_Arduino.md] — Câu 14`
