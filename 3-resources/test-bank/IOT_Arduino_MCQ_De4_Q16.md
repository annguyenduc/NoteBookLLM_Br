---
file_id: "IOT_Arduino_MCQ_De4_Q16"
...
![Image](../assets/ASSET_IOT_AI_Arduino_De4_rId25.png)

## 📝 Đáp án lựa chọn
- **A/ (Đáp án)** Khi trời không mưa thì đèn xanh sáng, đèn đỏ và còi tắt. Khi trời mưa thì đèn xanh sáng tiếp trong 3 giây sau đó tắt;  đèn đỏ sáng lên; còi buzzer báo động hú tắt liên tục (thời gian hú tắt đứt quãng là 1 giây) cho đến khi hết mưa.
