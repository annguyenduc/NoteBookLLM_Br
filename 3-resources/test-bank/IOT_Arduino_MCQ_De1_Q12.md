---
file_id: "IOT_Arduino_MCQ_De1_Q12"
...
![Image](../assets/ASSET_IOT_Arduino_De1_rId25.png)
B/ Động cơ Servo
...
![Image](../assets/ASSET_IOT_AI_Arduino_De3_rId46.png)
...
Cho mạch Arduino gồm các linh kiện điện tử như sau:
![Image](../assets/ASSET_IOT_Arduino_De1_rId27.png)
Hãy ghép chân của các linh kiện điện tử đã kết nối trên Arduino?
(Dạng ghép nối)
Đáp án

## 📝 Đáp án lựa chọn
- **A/ (Đáp án)** 2 đèn LED xanh, đỏ
- **A/ (Đáp án)** Khi sử dụng chức năng ghi âm của mạch ISD1820, đèn LED xanh lá sẽ sáng.
- **B/ (Đáp án)** Còi Buzzer không thể hoạt động được.

## 🔗 Liên kết tư duy
- [Rule 14] Đã mở file nguồn `3-resources/raw/Tổng hợp đề kiểm tra LMS/Tự động hóa và IOT/.../Đề trắc nghiệm 1 - AI Arduino.docx` và xác nhận fact.