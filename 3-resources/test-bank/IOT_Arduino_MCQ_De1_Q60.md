---
file_id: "IOT_Arduino_MCQ_De1_Q60"
title: "Câu 60 (Hiểu)"
...
![Image](../assets/ASSET_IOT_Arduino_De1_rId201.png)
![Image](../assets/ASSET_IOT_Arduino_De1_rId202.png)
Hỏi để điều chỉnh cho xe chạy thẳng khi khởi động, ta có thể sử dụng đoạn lệnh nào sau đây?

## 📝 Đáp án lựa chọn
- **A/ (Đáp án)**
  B/
  ![Image](../assets/ASSET_IOT_AI_Arduino_De4_rId81.png)
  ![Image](../assets/ASSET_IOT_AI_Arduino_De4_rId83.png)
- **B/**
- **C/**
  D/
  ![Image](../assets/ASSET_IOT_AI_Arduino_De4_rId82.png)
  ![Image](../assets/ASSET_IOT_AI_Arduino_De4_rId80.png)
  ĐỀ THỰC HÀNH
  Yêu cầu:
...
## 📖 Nguồn
`📖 Nguồn: [Bản sao của Bản sao của Đề kiểm tra Arduino module 1.docx] — 60`
