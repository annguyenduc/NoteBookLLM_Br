...
audit:
  ...
  verify_gaps: []
  signature: "UNSIGNED"
  verify_range: [164, 165]
  verify_range_source: "frontmatter"
  verify_manifest_range: [164, 165]
---

# HD SOURCE: ARCH_Thinking_in_Systems_CH06_SEC01_P164-165
Source PDF: ARCH_Thinking_in_Systems.pdf
Extracted Images: 0
Structure Mode: chapter>section>page
Chunk Unit ID: CH06_SEC01
...
Section Title: 12. Numbers-Constants and parameters such as subsidies, taxes, standards
Chunk Range: Pages 164 to 165
...
Consider  the  national  debt.  It  may  seem  like  a  strange  stock;  it  is  a money hole. The rate at which the hole deepens is called the annual defi  cit. Income from taxes shrinks the hole, government expenditures expand it. Congress and the president spend most of their time arguing about the many, many parameters that increase (spending) and decrease (taxing) the size or depth of the hole. Since those fl  ows are connected to us, the voters, these are politically charged parameters. But, despite all the fi  reworks, and no matter which party is in charge, the money hole has been deepening for years now, just at different rates.
