...
audit:
  ...
  verify_result: "PASS"
  verify_gaps: []
  signature: "79b792b9ea27a13f656fa2e8516d7f7a18213da5e88c3db9354349e7c854b7aa"
  verify_range: [221, 224]
  verify_range_source: "frontmatter"
  verify_manifest_range: [221, 224]
---

# HD SOURCE: ARCH_Thinking_in_Systems_FRONT_14_P221-224
...
5. Paraphrased from Herbert Simon, The Sciences of the Artifi  cial (Cambridge MA: MIT Press, 1969), 90-91 and 98-99.
...
15. 'T okyo Cuts Outlook on Growth to 1.6%,' International Herald Tribune, December 19-20, 1992, p. 11.
...
5. For an example, see Dennis Meadows's model of commodity price fl  uctuations: Dennis L. Meadows, Dynamics of Commodity Production Cycles (Cambridge, MA: Wright-Allen Press, Inc., 1970).
