---
title: Đề 2 trắc nghiệm - AI Arduino.docx
source: [[Đề 2 trắc nghiệm - AI Arduino.docx]]
type: RAW_SOURCE
---
...
Có thể cấp nguồn cho arduino thông qua pin với chân 3,3V hoặc 5V.

B/

Có thể cấp nguồn cho arduino bằng cách kết nối với máy tính thông qua dây cáp.

C/

Có thể cấp nguồn cho arduino thông qua dây adapter 9V.

D/

Có thể cấp nguồn cho arduino thông qua pin với cổng Vin.

Câu 2 (Nhận biết)

Nối tên với các bộ phận tương ứng

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId7.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId8.png)

A/

Phần chân âm của đèn led có dấu (-); chân dương của đèn led có dấu (+).

B/

Phần chân âm của đèn led dài hơn; chân dương của đèn led ngắn hơn.

C/

Phần chân dương của đèn led được đánh dấu bằng một lỗ tròn nhỏ, chân âm không có.

D/

Phần chân dương của đèn led dài hơn; chân âm của đèn led ngắn hơn.
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId9.png)

B/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId10.png)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId11.png)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId12.png)
...
PLAYE, PLAYL của mạch chỉ có thể được bật bằng cách nhấn nút thủ công.
...
Chân VCC của mạch được gắn với cổng 5V của Arduino.
...
Chân PLAYE, PLAYL của mạch chỉ có thể được gắn ở một số chân Digital không có dấu ngã (~) như: 2, 4, 7, 8, 12, 1

3. 13 của Arduino.

B/

Chân GND của mạch được gắn với cổng GND của Arduino.
...
2- Điện áp hoạt động của servo là 5V.
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId13.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId14.png)

d

B/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId15.png)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId16.png)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId17.png)

Câu 11 (Thông hiểu)

Cho mạch điện Arduino gồm 5 đèn LED như hình sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId18.png)

Hỏi khi bạn thực hiện chương trình sau thì có những đèn nào phát sáng ?

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId19.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId20.png)

Chọn đoạn chương trình phù hợp điền vào chỗ trống để các đèn led hoạt động giống như đoạn gif dưới đây

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId21.gif)

A/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId22.png)

B/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId23.png)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId24.png)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId25.png)

Câu 13 (Thông hiểu)

Cho mạch Arduino gồm các linh kiện điện tử như sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId26.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId27.png)

Đây là đoạn chương trình của học sinh đã thực hiện. Hỏi khi nhấn lá cờ xanh, những đèn LED nào sẽ phát sáng?

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId28.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId29.gif)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId30.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId31.png)

Cho đoạn chương trình như sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId32.png)

Hỏi khi nhấn phím mũi tên lên, sau đó 10 giây thì nhấn phím mũi tên xuống, đèn LED sẽ hoạt động như thế nào?

A/

Khi nhấn phím mũi tên lên, đèn LED chớp tắt liên tục mỗi 0,5 giây. Khi nhấn phím mũi tên xuống, đèn LED tắt trong thời gian ngắn, sau đó tiếp tục chớp tắt liên tục.

B/

Khi nhấn phím mũi tên lên, đèn LED chớp tắt liên tục mỗi 0,5 giây. Khi nhấn phím mũi tên xuống, đèn LED tắt hẳn.

C/

Khi nhấn phím mũi tên lên, đèn LED tắt. Khi nhấn phím mũi tên xuống, đèn LED sáng lên.

D/

Khi nhấn phím mũi tên lên, đèn LED sáng. Khi nhấn phím mũi tên xuống, đèn LED tắt đi.

Câu 17 (Thông hiểu)

Cho mạch điện Arduino với 1 động cơ Servo như hình sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId33.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId34.png)

B/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId35.png)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId36.png)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId37.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId38.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId39.gif)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId40.gif)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId41.gif)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId42.png)

Đoạn code nào có thể tương ứng với đoạn tắt đèn LED (trong hình vuông đỏ)?

A/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId43.png)

B/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId44.png)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId45.png)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId46.png)

Câu 20 (Thông hiểu)

Cho mạch Arduino gồm 1 đèn LED, 1 còi, 1 mạch thu phát âm thanh như sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId47.png)

Cho chương trình sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId48.png)
...
Khi nhấn phím Space, sau 3 tiếng kêu ngắt quãng của còi Buzzer, đèn LED sẽ sáng và mạch ISD1820 sẽ phát ra đoạn ghi âm đã được thu.

B/

Khi nhấn phím Space, đèn LED sẽ sáng đồng thời thu âm giọng của người dùng trong 10 giây rồi tắt.

C/

Khi nhấn phím Space, sau 3 tiếng kêu ngắt quãng của còi Buzzer, đèn LED sẽ sáng đồng thời thu âm giọng của người dùng trong 10 giây rồi tắt.

D/

Khi nhấn phím Space, đèn LED tắt đồng thời mạch ISD1820 sẽ phát ra đoạn ghi âm đã được thu, sau đó còi buzzer và đèn LED hoạt động trong 10 giây rồi tắt đi.

Câu 21 (Nhận biết)

Phát biểu nào sau đây là đúng khi nói về khối lệnh “Broadcast” và “When I receive message”?

A/ Chỉ có nhân vật truyền được tin nhắn.

Các tin nhắn có thể được truyền qua lại giữa nhân vật và Arduino.

B/

Việc truyền và nhận tin nhắn khi lập trình Arduino có thể sử dụng cả khi dùng chế độ UPLOAD và LIV

E.

C/

Linh kiện điện tử và nhân vật không thể truyền và nhận tin nhắn.
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId49.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId50.png)

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId51.png)

Chương trình của nhân vật như sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId52.png)

Hãy điền vào A câu lệnh còn thiếu để chương trình hoạt động theo yêu cầu trên:

A/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId53.png)

B/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId54.png)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId55.png)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId56.png)

Câu 23 (Thông hiểu)

Cho mạch điện Arduino với 1 động cơ Servo như hình sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId57.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId58.png)

Đáp án nào sau đây thể hiện chương trình của nhân vật để thực hiện yêu cầu trên?

A/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId59.png)

B/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId60.png)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId61.png)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId62.png)

Câu 24 (Thông hiểu)

Cho mạch điện Arduino với 1 đèn LED như hình sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId63.png)

Cho chương trình gồm 1 nhân vật đèn “Bulb” có 2 trang phục như hình sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId64.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId65.png)

Đáp án nào sau đây thể hiện câu lệnh của Arduino để thực hiện yêu cầu trên?

A/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId66.png)

B/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId67.png)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId68.png)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId69.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId70.png)

Cho chương trình gồm 1 nhân vật có chương trình như sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId71.png)

Biết rằng chương trình của thiết bị Arduino được lập trình như sau:

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId72.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId73.png)

Đáp án nào sau đây thể hiện chương trình của Arduino để thực hiện yêu cầu trên?

A/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId74.png)

B/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId75.png)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId76.png)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId77.png)
...
Cần phải đăng nhập mới được sử dụng extension Teachable Machine.
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId78.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId79.png)

Đáp án nào sau đây thể hiện chương trình của Arduino để thực hiện yêu cầu trên?

A/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId80.png)

B/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId81.png)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId82.png)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId83.png)
...
![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId84.png)

B/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId85.png)

C/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId86.png)

D/

![Image](../assets/IOT_AI_Arduino_Đề_2_trắc_nghiệm_-_AI_Arduino_rId87.png)