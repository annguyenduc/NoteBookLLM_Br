...
| **L2** | **Episodic Memory** | `3-resources/raw/` | I/O Logs: Dấu vết thực thi thô từ bầy đàn Agent. |
| **L3** | **Semantic Local** | `3-resources/distilled/` | **LLM Wiki (Kernel)**: Tri thức chưng cất, liên kết bằng `[[Wikilinks]]`. |
...
1.  **Ingestion**: Thu nhận Log thô từ `3-resources/raw/`.
