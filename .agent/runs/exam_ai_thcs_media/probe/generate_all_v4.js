/**
 * generate_all_v4.js
 * Final working script: generate PNG + XML for all 10 AI THCS exercises
 * Pattern confirmed from BT1 v3 probe:
 *   - Add Extension: [class*="extension-button"]
 *   - Card click: text="Extension Name" (fallback)
 * Status: PREVIEW_ONLY
 */
...
async function loadExtension(page, displayName) {
  ...
  try {
    ...
    console.log(`  [WARN] Extension click failed: ${displayName}`);
    // Try back
    try { await page.click('text="Back"', { timeout: 2000 }); await page.waitForTimeout(500); } catch (e2) {}
    return false;
  }
}
...
// ============================================================
// EXERCISES 2-10 DEFINITIONS
// BT1 already done. Running BT2-BT10.
// ============================================================
...
const exercises = [
      ...
      <block type="sensing_askandwait" id="bt2_ask_lang">
        ...
        <next>
          <block type="data_setvariableto" id="bt2_set_lang">
            <field name="VARIABLE">NgonNgu</field>
                  ...
                  <block type="control_if_else" id="bt2_if_lang1">
                    <value name="CONDITION">
                      <block type="operator_equals" id="bt2_eq1">
                        <value name="OPERAND1"><block type="data_variable" id="bt2_lang_var"><field name="VARIABLE">NgonNgu</field></block></value>
  ...
  <block type="event_whenbroadcastreceived" id="bt2_canh2" x="520" y="40">
    <field name="BROADCAST_OPTION">Canh 2</field>
    <next>
          ...
          <block type="control_if_else" id="bt2_if_lang2">
            <value name="CONDITION">
              <block type="operator_equals" id="bt2_eq2">
                <value name="OPERAND1"><block type="data_variable" id="bt2_lang_var2"><field name="VARIABLE">NgonNgu</field></block></value>
                <value name="OPERAND2"><shadow type="text"><field name="TEXT">2</field></shadow></value>
              </block>
            </value>
            <statement name="SUBSTACK">
                              ...
                              <block type="control_if" id="bt3_if_cong">
                                ...
                                <statement name="SUBSTACK">
                                  <block type="data_setvariableto" id="bt3_calc_cong">
                                    <field name="VARIABLE">KetQua</field>
                                    <value name="VALUE">
                                      <block type="operator_add" id="bt3_add">
                                        <value name="NUM1"><block type="data_variable" id="bt3_s1a"><field name="VARIABLE">So1</field></block></value>
                                        <value name="NUM2"><block type="data_variable" id="bt3_s2a"><field name="VARIABLE">So2</field></block></value>
                                      </block>
                                    </value>
                                    <next>
                                      <block type="text2speech_speakAndWait" id="bt3_tts_cong">
                                        <value name="WORDS">
                                          <block type="operator_join" id="bt3_j1">
                                            <value name="STRING1"><block type="data_variable" id="bt3_s1j"><field name="VARIABLE">So1</field></block></value>
                                            <value name="STRING2">
                                              <block type="operator_join" id="bt3_j2">
                                                ...
                                                <value name="STRING2">
                                                  <block type="operator_join" id="bt3_j3">
                                                    <value name="STRING1"><block type="data_variable" id="bt3_s2j"><field name="VARIABLE">So2</field></block></value>
                                                    <value name="STRING2">
                                                      <block type="operator_join" id="bt3_j4">
                                                        <value name="STRING1"><shadow type="text"><field name="TEXT"> bang </field></shadow></value>
                                                        <value name="STRING2"><block type="data_variable" id="bt3_kq_j"><field name="VARIABLE">KetQua</field></block></value>
                                                      </block>
                                                    </value>
                                                  </block>
                                                </value>
              ...
              <block type="data_addtolist" id="bt4_add_q1">
                ...
                <next>
                  <block type="data_addtolist" id="bt4_add_a1">
                    <field name="LIST">DapAnDung</field>
                      ...
                      <block type="control_repeat_until" id="bt4_loop">
                        <value name="CONDITION">
                          <block type="operator_gt" id="bt4_check_vong">
                            <value name="OPERAND1"><block type="data_variable" id="bt4_vong_var"><field name="VARIABLE">Vong</field></block></value>
                          ...
                          <block type="text2speech_speakAndWait" id="bt4_tts_q">
                            <value name="WORDS">
                              <block type="data_itemoflist" id="bt4_get_q">
                                <value name="INDEX"><block type="data_variable" id="bt4_vong_idx"><field name="VARIABLE">Vong</field></block></value>
                                <field name="LIST">CauHoi</field>
                              </block>
                            </value>
                            <next>
                              <block type="sensing_askandwait" id="bt4_ask">
                                <value name="QUESTION">
                                  <block type="data_itemoflist" id="bt4_get_q2">
                                    <value name="INDEX"><block type="data_variable" id="bt4_vong_idx2"><field name="VARIABLE">Vong</field></block></value>
                                    <field name="LIST">CauHoi</field>
                                  </block>
                                </value>
                                <next>
                                      ...
                                      <block type="operator_equals" id="bt4_eq">
                                        ...
                                        <value name="OPERAND2">
                                          <block type="data_itemoflist" id="bt4_get_a">
                                            <value name="INDEX"><block type="data_variable" id="bt4_vong_idx3"><field name="VARIABLE">Vong</field></block></value>
                                            <field name="LIST">DapAnDung</field>
                                          </block>
                                        </value>
                                      </block>
  ...
  <block type="event_whenbroadcastreceived" id="bt4_kq_sprite" x="520" y="40">
    <field name="BROADCAST_OPTION">KetQua</field>
    <next>
          ...
          <block type="operator_join" id="bt4_join_kq">
            ...
            <value name="STRING2">
              <block type="operator_join" id="bt4_join_kq2">
                <value name="STRING1"><block type="data_variable" id="bt4_diem_j"><field name="VARIABLE">Diem</field></block></value>
                  ...
                  <block type="operator_join" id="bt4_join_eng">
                    ...
                    <value name="STRING2">
                      <block type="operator_join" id="bt4_join_eng2">
                        <value name="STRING1"><block type="data_variable" id="bt4_diem_e"><field name="VARIABLE">Diem</field></block></value>
                        <value name="STRING2"><shadow type="text"><field name="TEXT"> tren 5 diem!</field></shadow></value>
                      </block>
                    </value>
                  </block>
  ...
  <block type="event_whenflagclicked" id="bt6_start" x="40" y="40">
    <next>
      <block type="data_setvariableto" id="bt6_set_soLan">
        <field name="VARIABLE">SoLan</field>
        <value name="VALUE"><shadow type="math_number"><field name="NUM">0</field></shadow></value>
        <next>
          <block type="data_setvariableto" id="bt6_set_daDem">
            <field name="VARIABLE">DaDem</field>
            <value name="VALUE"><shadow type="math_number"><field name="NUM">0</field></shadow></value>
            <next>
                                  ...
                                  <block type="operator_and" id="bt6_and_cond">
                                    ...
                                    <value name="OPERAND2">
                                      <block type="operator_equals" id="bt6_eq_dem">
                                        <value name="OPERAND1"><block type="data_variable" id="bt6_daDem_v"><field name="VARIABLE">DaDem</field></block></value>
                                      ...
                                      <block type="data_setvariableto" id="bt6_set_dem1">
                                        ...
                                        <next>
                                          <block type="text2speech_speakAndWait" id="bt6_tts_count">
                                            <value name="WORDS"><block type="data_variable" id="bt6_soLan_v"><field name="VARIABLE">SoLan</field></block></value>
                                          </block>
                                        </next>
                                      </block>
                                    </next>
          ...
          <block type="control_if" id="bt7_if_b1">
            ...
            <statement name="SUBSTACK">
              <block type="event_broadcast" id="bt7_bc1">
                <value name="BROADCAST_INPUT"><shadow type="event_broadcast_menu"><field name="BROADCAST_OPTION">Bai 1</field></shadow></value>
              </block>
            </statement>
          </block>
        </next>
  ...
  <block type="event_whenbroadcastreceived" id="bt7_bai1" x="40" y="350">
    <field name="BROADCAST_OPTION">Bai 1</field>
    <next>
  ...
  <block type="faceDetection_whenFace" id="bt7_face_smile" x="520" y="350">
    ...
    <next>
      <block type="event_broadcast" id="bt7_bc_next">
        <value name="BROADCAST_INPUT"><shadow type="event_broadcast_menu"><field name="BROADCAST_OPTION">Bai 2</field></shadow></value>
      </block>
    </next>
  </block>
</xml>`
                  ...
                  <block type="control_repeat_until" id="bt8_fall_loop">
                    <value name="CONDITION">
                      <block type="operator_equals" id="bt8_tg_check">
                        <value name="OPERAND1"><block type="data_variable" id="bt8_tg_v"><field name="VARIABLE">ThoiGian</field></block></value>
                        <value name="OPERAND2"><shadow type="math_number"><field name="NUM">0</field></shadow></value>
                      </block>
                    </value>
                    <statement name="SUBSTACK">
          ...
          <block type="operator_join" id="bt8_join_result">
            ...
            <value name="STRING2">
              <block type="operator_join" id="bt8_join_result2">
                <value name="STRING1"><block type="data_variable" id="bt8_diem_j"><field name="VARIABLE">Diem</field></block></value>
  ...
  <block type="event_whenbroadcastreceived" id="bt9_doi_trang_suc" x="40" y="300">
    <field name="BROADCAST_OPTION">DoiTrangSuc</field>
    <next>
  ...
  <block type="event_whenkeypressed" id="bt9_space" x="520" y="40">
    ...
    <next>
      <block type="data_setvariableto" id="bt9_set_idx">
        <field name="VARIABLE">ChiSoCostume</field>
        <value name="VALUE">
        ...
        <next>
          <block type="event_broadcast" id="bt9_bc_doi">
            <value name="BROADCAST_INPUT"><shadow type="event_broadcast_menu"><field name="BROADCAST_OPTION">DoiTrangSuc</field></shadow></value>
            <next>
  ...
  <block type="event_whenflagclicked" id="bt10_start" x="40" y="40">
    <next>
      <block type="data_deletealloflist" id="bt10_clear">
        <field name="LIST">DaDiemDanh</field>
        <next>
              ...
              <block type="control_repeat_until" id="bt10_loop">
                <value name="CONDITION">
                  <block type="operator_equals" id="bt10_tg_check">
                    <value name="OPERAND1"><block type="data_variable" id="bt10_tg_v"><field name="VARIABLE">ThoiGian</field></block></value>
                    <value name="OPERAND2"><shadow type="math_number"><field name="NUM">0</field></shadow></value>
                  </block>
                </value>
                <statement name="SUBSTACK">
  ...
  <block type="event_whenbroadcastreceived" id="bt10_tong_ket" x="520" y="40">
    <field name="BROADCAST_OPTION">HetGio</field>
    <next>
      <block type="data_setvariableto" id="bt10_count">
        <field name="VARIABLE">SoCo</field>
        <value name="VALUE">
              ...
              <block type="operator_join" id="bt10_join1">
                ...
                <value name="STRING2">
                  <block type="operator_join" id="bt10_join2">
                    <value name="STRING1"><block type="data_variable" id="bt10_soco_v"><field name="VARIABLE">SoCo</field></block></value>
                      ...
                      <block type="operator_join" id="bt10_join3">
                        ...
                        <value name="STRING2">
                          <block type="operator_join" id="bt10_join4">
                            <value name="STRING1"><block type="data_variable" id="bt10_soco_v2"><field name="VARIABLE">SoCo</field></block></value>
                            <value name="STRING2"><shadow type="text"><field name="TEXT"> tren 3 thanh vien diem danh.</field></shadow></value>
                          </block>
                        </value>
                      </block>
...
(async () => {
  console.log('=== PRG AI Blocks v4 — Generate BT2 to BT10 (confirmed working pattern) ===');
