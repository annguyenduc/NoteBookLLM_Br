/**
 * generate_all_v7.js
 * Batch generator with corrected opcodes for Face Sensing and Body Sensing blocks.
 * Status: PREVIEW_ONLY
 */
...
// ============================================================
// EXERCISES 2-10 DEFINITIONS (WITH CORRECTED OPCODES)
// ============================================================
...
const exercises = [
  ...
  // BT5: Nhan vat phan ung cam xuc - Face Sensing + Translate (Corrected poseFace)
  {
    id: 5,
  ...
  // BT6: The duc AI - Body Sensing + TTS (Corrected poseBody)
  {
    id: 6,
  ...
  // BT7: Phong hoc ao - Translate + TTS + Face Sensing (Corrected poseFace)
  {
    id: 7,
  ...
  // BT9: Bo loc AR - Body Sensing + Translate + TTS (Corrected poseBody)
  {
    id: 9,
...
(async () => {
  console.log('=== PRG AI Blocks v7 — Generate BT2 to BT10 (Corrected Opcodes) ===');
