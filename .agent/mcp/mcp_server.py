...
class SimpleFilteredStdout:
    ...
    def write(self, s):
        # Filter out banner lines (╭, │, ╰, ─) and FastMCP info
...
# Patch stdout BEFORE FastMCP initializes
sys.stdout = SimpleFilteredStdout(sys.stdout)
# --- END CLEAN STDOUT LOGIC ---
