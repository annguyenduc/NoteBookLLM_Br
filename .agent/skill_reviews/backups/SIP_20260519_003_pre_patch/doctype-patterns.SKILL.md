...
description: "CORE — Các mẫu tạo DocType của Frappe, loại field, hook controller và các phương pháp thiết kế data model tốt nhất."
version: 1.0.0
---
# Doctype Patterns

## Goal
Execute the `doctype-patterns` workflow safely and consistently.
...
## Examples
- User asks for work aligned with `doctype-patterns`.
