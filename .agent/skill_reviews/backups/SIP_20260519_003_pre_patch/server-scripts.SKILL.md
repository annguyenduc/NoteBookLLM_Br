...
name: server-scripts
description: "CORE — Các mẫu Python phía server của Frappe cho controller, sự kiện document, whitelisted API, job nền và thao tác database."
version: 1.0.0
---
# Server Scripts

## Goal
Execute the `server-scripts` workflow safely and consistently.
...
## Examples
- User asks for work aligned with `server-scripts`.
