...
name: client-scripts
description: "CORE — Các mẫu JavaScript phía client của Frappe cho sự kiện form, thao tác field, dialog và tùy chỉnh UI."
version: 1.0.0
---
# Client Scripts

## Goal
Execute the `client-scripts` workflow safely and consistently.
...
## Examples
- User asks for work aligned with `client-scripts`.
