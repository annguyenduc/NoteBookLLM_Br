...
description: "CORE — LITE — Toàn bộ vòng đời Frappe: phát triển, test, deploy. Chuyên gia ERPNext."
version: 4.2.2
---
# Cm Frappe Agent

## Goal
Execute the `cm-frappe-agent` workflow safely and consistently.
...
## Examples
- User asks for work aligned with `cm-frappe-agent`.
