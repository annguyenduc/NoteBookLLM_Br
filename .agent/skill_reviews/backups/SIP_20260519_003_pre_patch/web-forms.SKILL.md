...
name: web-forms
description: "CORE — Các mẫu phát triển Frappe Web Form — client script, CSS, quyền truy cập khách và các lỗi thường gặp."
version: 1.0.0
---
# Web Forms

## Goal
Execute the `web-forms` workflow safely and consistently.
...
## Examples
- User asks for work aligned with `web-forms`.
