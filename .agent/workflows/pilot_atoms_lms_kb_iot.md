# WORKFLOW: Pilot — Tạo Atomic Notes từ LMS_KB_IOT.md
# Lưu tại: .agent/workflows/pilot_atoms_lms_kb_iot.md
# Dùng trong Antigravity: paste prompt từng bước vào chat

---

## MỤC TIÊU
Tạo ~10 atomic notes mẫu từ file `brain/raw/LMS_KB_IOT.md`
vào `brain/atoms/` theo đúng template `ATOMS_TEMPLATE.md`.

## ĐIỀU KIỆN TIÊN QUYẾT
- [ ] `brain/raw/LMS_KB_IOT.md` tồn tại
- [ ] `brain/atoms/ATOMS_TEMPLATE.md` tồn tại
...
CHECKPOINT:
  ...
  prerequisites:
    - file: "brain/raw/LMS_KB_IOT.md"
      exists: "?"
    - file: "brain/atoms/ATOMS_TEMPLATE.md"  
      exists: "?"
...
CHECKPOINT:
  agent: "@scout"
  task: "Tạo atomic notes cho 5 tags đã chọn"
  step: "2 / 4"
  output_file: "brain/atoms/ATOMS_[TAG].md × 5 files"
...
Với MỖI tag:
1. Đọc template tại `brain/atoms/ATOMS_TEMPLATE.md`
2. Tạo file `brain/atoms/ATOMS_[tên_tag_snake_case].md`
...
Mở từng file trong `brain/atoms/`, kiểm tra checklist:
