---
name: course-writer
description: Tòa soạn báo AI — viết tiếng Việt chuyên nghiệp, tối ưu hóa cho việc viết khóa học. Tổng biên tập nhận đề bài → phân vai → điều phối các ban.
---

# Viết Khóa Học (Course Writer) 3.1 — Tổng Biên Tập
