...
| **L2** | **Episodic Memory** | `brain/raw/` | I/O Logs: Dấu vết thực thi thô (Input cho chưng cất). |
| **L3** | **Semantic Local** | `brain/distilled/` | **LLM Wiki**: Tri thức chưng cất, liên kết bằng ``Wikilinks``. |
