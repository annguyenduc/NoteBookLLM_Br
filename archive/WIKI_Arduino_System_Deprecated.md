...
- [x] **[Rule 14]** Đã mở file nguồn trong brain/raw/ và xác nhận fact tồn tại (Câu 1: Kết nối Arduino với máy tính; Câu 14: Lập trình LED; Câu 30: Ứng dụng xe Arduino).
