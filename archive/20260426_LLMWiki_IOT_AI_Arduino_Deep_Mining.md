...
| :--- | :--- | :--- |
| **Số tệp nguồn đã quét** | 8 tệp | Đề AI 1-4 và Đề Tự động hóa AI 1-4 |
| **Tổng số câu hỏi** | 238 câu | Quét toàn bộ kho AI Arduino |
| **Nguyên tử tri thức (Atoms)** | 42 | Các khái niệm AI & Logic độc lập |
| **Tỷ lệ tri thức/câu hỏi** | **1 : 5.6** | Mật độ tri thức trung bình |
