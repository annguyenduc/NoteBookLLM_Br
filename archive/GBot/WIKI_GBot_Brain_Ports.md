...
- [x] **[Rule 14]** Đã mở file nguồn trong brain/raw/ và xác nhận fact tồn tại (Câu 3: cổng nguồn; Câu 4: Servo cổng 5,6; cổng motor M1, M2; Câu 25: nút nhấn trung tâm dùng chuyển chế độ).
