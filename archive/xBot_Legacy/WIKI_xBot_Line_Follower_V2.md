...
- [x] **[Rule 14]** Đã mở file nguồn trong brain/raw/ và xác nhận fact tồn tại (Câu 27: Nguyên lý hồng ngoại; Câu 28: Cách hiệu chuẩn bằng nút nhấn khi đặt trên vạch đen).
