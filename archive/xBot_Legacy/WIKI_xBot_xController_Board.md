...
- [x] **[Rule 14]** Đã mở file nguồn trong brain/raw/ và xác nhận fact tồn tại (Câu 1: 6 cổng mở rộng; Câu 4: Không tích hợp sẵn cảm biến siêu âm; Câu 13: Có 2 đèn LED RGB; Câu 20: Có loa tích hợp).
